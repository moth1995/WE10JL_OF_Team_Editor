...
class BasicSettings:
    def __init__(self,player):
        ...
        self.age = Stat(player, 65, 9, 31, "Age", "{stat} + 15 if {normalize} else {stat} - 15", 15, 46)# +15
        ...
        self.goal_celebration_1 = Stat(player, 37, 1, 127, "Goal Celebration 1")
        self.goal_celebration_2 = Stat(player, 38, 0, 127, "Goal Celebration 2")
        self.growth_type= Stat(player, 39, 0, 0xFF, "Growth type", None, 0, 0xFF)
